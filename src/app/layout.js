...
export const metadata = {
  title: "Reading Recoder",
  description: "自分で読んだ書籍を記録に残すためのアプリ",
};
  ...
  return (
    <html lang="ja">
      <body className={fnt.className}>
        <h1 className="text-4xl text-indigo-800 font-bold my-2">Reading Recoder</h1>
        <ul className="flex bg-bule-600 mb-4 pl-2">
